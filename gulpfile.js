...
function startwatch() {
	watch('app/**/*.pug', { usePolling: true }, html);
	watch('app/**/*.styl', { usePolling: true }, styles);
	// watch('app/img/**/*', images);
	watch('app/libs/**/*.css', { usePolling: true }, css);
	watch('app/libs/**/*.js', { usePolling: true }, js);
	watch('app/js/**/*.js', { usePolling: true }, js_reload);
	// watch('app/img/sprite/*.svg', svg);
}

exports.build = series(clear, html, styles, copy)
exports.default = series(html, parallel(css, js, styles, browsersync, startwatch))
